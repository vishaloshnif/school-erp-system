...
{ 
	...
	if(isset($_FILES['image']['name'])&&$_FILES['image']['name']!="")
	{
		...
		$previous_class_certificate=$_POST['previous_class_certificate'];
		 ...
		 $sql1="SELECT * FROM student_info where registration_no='".$registration_no."'";
	$res1=mysql_query($sql1) or die("Error : " . mysql_error());
	$num=mysql_num_rows($res1);
	if($num==0)
	{
		 $sql_insert_q="insert into student_info(registration_no,student_admission_no,addmission_date,name,dob,class,stream,subject,student_type,admission_fee,category,gender,image,s_address,country,state,city,pin_code,s_mobile_no,s_email,f_name,m_name,f_address,f_mobile_no,f_email,caste_certificate,bonafied_cetificate,income_certificate,previous_class_certificate,session)values('".$registration_no."','".$student_admission_no."','".$addmission_date."','".$name."','".$dob."','".$class."','".$stream."','".$subject."','".$student_type."','".$admission_fee."','".$category."','".$gender."','".$image."','".$s_address."','".$country."','".$state."','".$city."','".$pin_code."','".$s_mobile_no."','".$s_email."','".$f_name."','".$m_name."','".$f_address."','".$f_mobile_no."','".$f_email."','".$caste_certificate."','".$bonafied_cetificate."','".$income_certificate."','".$previous_class_certificate."','".$_SESSION['session']."')";
	mysql_query($sql_insert_q);
	header('location:admission.php?msg=1');
	...
	$sql10="SELECT max(registration_no) FROM student_info where session='".$_SESSION['session']."'";
								...
								<div class="form_grid_12 multiline">
                                    ...
                                    <div class="form_input" >
                                        ...
                                        <div class="form_grid_4 alpha"  id="checkregno" >
											<input name="registration_no"   type="text" style=" margin-left:-192px;"  required onBlur="getCheckreg('checkregno.php?registration_no='+this.value)"/>										
										</div>
